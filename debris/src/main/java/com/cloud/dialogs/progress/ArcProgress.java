package com.cloud.dialogs.progress;
...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = PixelUtils.sp2px(context, 18);
        min_size = (int) PixelUtils.dip2px(context, 100);
        default_text_size = PixelUtils.sp2px(context, 40);
        default_suffix_text_size = PixelUtils.sp2px(context, 15);
        default_suffix_padding = PixelUtils.dip2px(context, 4);
        default_suffix_text = "%";
        default_bottom_text_size = PixelUtils.sp2px(context, 10);
        default_stroke_width = PixelUtils.dip2px(context, 4);
