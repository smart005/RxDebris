package com.cloud.images2.adapter;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (isShowCamera()) {
            if (i == 0) {
                view = mInflater.inflate(R.layout.cl_mis_list_item_camera, viewGroup, false);
                return view;
            }
        }
        ...
        ViewHolder holder;
        if (view == null) {
            view = mInflater.inflate(R.layout.cl_mis_list_item_image, viewGroup, false);
        ...
        void bindData(final ImageItem data) {
            ...
            if (showSelectIndicator) {
                ...
                if (mSelectedImages.contains(data)) {
                    // 设置选中状态
                    indicator.setImageResource(R.drawable.cl_mis_btn_selected);
                    mask.setVisibility(View.VISIBLE);
                } else {
                    // 未选择
                    indicator.setImageResource(R.drawable.cl_mis_btn_unselected);
