package com.cloud.components.seekbar;
...
public class BubbleSeekBar extends View {
    ...
    public enum TextPosition {
        SIDES, BOTTOM_SIDES, BELOW_SECTION_MARK;
    }
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_track_size, PixelUtils.dip2px(context, 2));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_second_track_size,
                mTrackSize + PixelUtils.dip2px(context, 2));
        mThumbRadius = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_thumb_radius,
                mSecondTrackSize + PixelUtils.dip2px(context, 2));
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color, Color.parseColor("#607D8B"));
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color, Color.parseColor("#FF9800"));
        ...
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_section_text_size, PixelUtils.sp2px(context, 14));
        ...
        if (pos == 0) {
            mSectionTextPosition = TextPosition.SIDES.ordinal();
        } else if (pos == 1) {
            mSectionTextPosition = TextPosition.BOTTOM_SIDES.ordinal();
        } else if (pos == 2) {
            mSectionTextPosition = TextPosition.BELOW_SECTION_MARK.ordinal();
        } else {
        ...
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_thumb_text_size, PixelUtils.sp2px(context, 14));
        ...
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_bubble_text_size, PixelUtils.sp2px(context, 14));
        ...
        mRectText = new Rect();
        mTextSpace = PixelUtils.dip2px(context, 2);
    ...
    private void initConfigByPriority() {
        ...
        if (mSecondTrackSize < mTrackSize) {
            mSecondTrackSize = mTrackSize + PixelUtils.dip2px(getContext(), 2);
        }
        if (mThumbRadius <= mSecondTrackSize) {
            mThumbRadius = mSecondTrackSize + PixelUtils.dip2px(getContext(), 2);
        }
        ...
        if (isShowSectionText) {
            ...
            if (mSectionTextPosition == TextPosition.BELOW_SECTION_MARK.ordinal()) {
        ...
        mThumbTextSize = isFloatType || isSeekBySection || (isShowSectionText && mSectionTextPosition ==
                TextPosition.BELOW_SECTION_MARK.ordinal()) ? mSectionTextSize : mThumbTextSize;
    }
    ...
    private void calculateRadiusOfBubble() {
        ...
        mBubbleRadius = PixelUtils.dip2px(getContext(), 14); // default 14dp
        int max = Math.max(mBubbleRadius, Math.max(w1, w2));
        mBubbleRadius = max + mTextSpace;
    }

    private void initSectionTextArray() {
        boolean ifBelowSection = mSectionTextPosition == TextPosition.BELOW_SECTION_MARK.ordinal();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isShowSectionText && mSectionTextPosition >= TextPosition.BOTTOM_SIDES.ordinal()) { // 如果Section值在track之下显示，比较取较大值
        ...
        height += mTextSpace * 2;
        setMeasuredDimension(resolveSize(PixelUtils.dip2px(getContext(), 180), widthMeasureSpec), height);
        ...
        if (isShowSectionText) {
            ...
            if (mSectionTextPosition == TextPosition.SIDES.ordinal()) {
            ...
            } else if (mSectionTextPosition >= TextPosition.BOTTOM_SIDES.ordinal()) {
                String text = mSectionTextArray.get(0);
                mPaint.getTextBounds(text, 0, text.length(), mRectText);
    ...
    private void locatePositionOnScreen() {
        ...
        mBubbleCenterRawSolidY -= PixelUtils.dip2px(getContext(), 24);
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowSectionText) {
            ...
            if (mSectionTextPosition == TextPosition.SIDES.ordinal()) {
                ...
                y_ += mRectText.height();
                xLeft = mLeft;
                if (mSectionTextPosition == TextPosition.BOTTOM_SIDES.ordinal()) {
        ...
        if ((!isShowSectionText && !isShowThumbText) || mSectionTextPosition == TextPosition.SIDES.ordinal()) {
        ...
        boolean isShowTextBelowSectionMark = isShowSectionText && mSectionTextPosition ==
                TextPosition.BELOW_SECTION_MARK.ordinal();
        ...
        if (isShowTextBelowSectionMark || isShowSectionMark) {
            ...
            float r = (mThumbRadiusOnDragging - PixelUtils.dip2px(getContext(), 2)) / 2f;
        ...
        if (isShowThumbText && !isThumbOnDragging && isTouchToSeekAnimEnd) {
            ...
            if (isFloatType || (isShowProgressInFloat && mSectionTextPosition == TextPosition.BOTTOM_SIDES.ordinal() &&
    ...
    private boolean isThumbTouched(MotionEvent event) {
        ...
        int offest = PixelUtils.dip2px(getContext(), 8);
        return (event.getX() - x) * (event.getX() - x) + (event.getY() - y) * (event.getY() - y)
                <= (mLeft + offest) * (mLeft + offest);
    }
    ...
    class BubbleView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            int offest = PixelUtils.dip2px(getContext(), 2);
            mBubblePath.reset();
