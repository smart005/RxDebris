...
public class BubbleConfigBuilder {
    ...
    public BubbleConfigBuilder trackSize(Context context, int dp) {
        this.trackSize = PixelUtils.dip2px(context, dp);
        return this;
    }

    public BubbleConfigBuilder secondTrackSize(Context context, int dp) {
        this.secondTrackSize = PixelUtils.dip2px(context, dp);
        return this;
    }

    public BubbleConfigBuilder thumbRadius(Context context, int dp) {
        this.thumbRadius = PixelUtils.dip2px(context, dp);
        return this;
    }

    public BubbleConfigBuilder thumbRadiusOnDragging(Context context, int dp) {
        this.thumbRadiusOnDragging = PixelUtils.dip2px(context, dp);
        return this;
    }
    ...
    public BubbleConfigBuilder sectionTextSize(Context context, int sp) {
        this.sectionTextSize = PixelUtils.sp2px(context, sp);
        return this;
    }
    ...
    public BubbleConfigBuilder thumbTextSize(Context context, int sp) {
        this.thumbTextSize = PixelUtils.sp2px(context, sp);
        return this;
    }
    ...
    public BubbleConfigBuilder bubbleTextSize(Context context, int sp) {
        this.bubbleTextSize = PixelUtils.sp2px(context, sp);
        return this;
    }
